...
//					FriendlyMessage friendlyMessage = dataSnapshot.child(CHILD_MESSAGES).child(key).getValue(FriendlyMessage.class);
					...
					String partingSlot = null;
					try{
						cost=dataSnapshot.child(CHILD_MESSAGES).child(key).child("Cost").getValue().toString();
  				    	uname=dataSnapshot.child(CHILD_MESSAGES).child(key).child("username").getValue().toString();
						noplate=dataSnapshot.child(CHILD_MESSAGES).child(key).child("text").getValue().toString();
                    	parkingTime=dataSnapshot.child(CHILD_MESSAGES).child(key).child("Parking time").getValue().toString();
                    	partingSlot=dataSnapshot.child(CHILD_MESSAGES).child(key).child("Parking Slot").getValue().toString();
